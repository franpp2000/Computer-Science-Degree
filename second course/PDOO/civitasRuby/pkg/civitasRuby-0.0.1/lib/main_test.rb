...
module Civitas
	...
	class MainTest
		...
		def main_sorpresas
			...
			mazo = Mazo_sorpresas.new(false)
			s = Sorpresa.new_por_valor(Civitas::Tipo_sorpresa::PORCASAHOTEL, valor, "porCasaHotel")
		...
		def main_civitas_juego
			...
			n_jugadores.push("Antonio")
			n_jugadores.push("Jose")
			n_jugadores.push("Panita")
			
			juego = Civitas_juego.new(n_jugadores)
