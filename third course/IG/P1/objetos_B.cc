...
_mifigura::_mifigura(float tam){
	...
	vertices[6].x = tam; vertices[6].y = tam; vertices[6].z = 0;
	vertices[7].x = 0; vertices[7].y = tam; vertices[7].z = 0;
	vertices[8].x = tam / 2; vertices[8].y = 2 * tam; vertices[8].z = tam / 2;
	vertices[9].x = tam / 2; vertices[9].y = -tam; vertices[9].z = tam / 2;
	...
	caras[6]._0=0;caras[6]._1=3;caras[6]._2=7;
	caras[7]._0=0;caras[7]._1=7;caras[7]._2=4;
	caras[8]._0=4;caras[8]._1=5;caras[8]._2=8;
	caras[9]._0=5;caras[9]._1=6;caras[9]._2=8;
	caras[10]._0=6;caras[10]._1=7;caras[10]._2=8;
	caras[11]._0=7;caras[11]._1=8;caras[11]._2=4;
	caras[12]._0=0,caras[12]._1=1;caras[12]._2=9;
	caras[13]._0=0;caras[13]._1=9;caras[13]._2=3;
	caras[14]._0=1;caras[14]._1=2;caras[14]._2=9;
	caras[15]._0=2;caras[15]._1=3;caras[15]._2=9;
}
