...
{
float   luz1[]={0.0, 1.0, 0.0, 1.0},
		luz2[]={0.0, 0.0, 1.0, 1.0},
...
switch (toupper(Tecla1)){
	...
	case '6':mov=0;mov2=0;mov3=0;mov4=0;mov5=0;mov6=0;break;
		...
		case '8':modo=SOLID_ILLUMINATED_GOURAUD;break;
			...
			case 'L':alfa+=10; break;
			case 'K':alfa-=10; break;
			case 'J':beta+=10; break;
			case 'H':beta-=10; break;
