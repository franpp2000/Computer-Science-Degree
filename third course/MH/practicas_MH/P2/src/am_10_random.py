...
def am_10_random(tam_poblacion, n, m, elementos, m_dist):
    t = 0
    g = 0
    ...
    n_aplicar_bl = int(0.1 * tam_poblacion)
    ...
    while t < 100000:
        ...
        if g % 10 == 0:
            #start = time.time()
            poblacion, eval = aplicar_BL_random(
                n_aplicar_bl, poblacion, n, m, elementos, m_dist)
            #end = time.time()
...
for file in contenido:
    ...
    start = time.time()
    sol = am_10_random(10, n, m, np.arange(
